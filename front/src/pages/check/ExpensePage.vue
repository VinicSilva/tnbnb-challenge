...
import CardExpense from './components/CardCheck.vue';
import { useAuth } from 'src/composable/auth';
import dayjs from 'dayjs';
import { formatPrice } from 'src/utils';
import ModalAddExpense from './components/ModalAddCheck.vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    const listBreadcrumbs = computed(() => {
      return [{ label: 'Expense> ', icon: 'mdi-arrow-bottom-left' }];
    });
